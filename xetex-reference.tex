...
Home on the web:
\url{https://ctan.org/pkg/xetexref}.
...
or made undefined.  If the primitive was expandable, \cmd|\primitive| expands
...
\cmd|\filedump|
\texttt{[offset]} \xargs{number}
\texttt{[length]} \xargs{number}
\xarg{file}
...
To conclude: for bug reporting, patches (please), and any other
discussion, please see \url{https://ctan.org/pkg/xetexref}.
