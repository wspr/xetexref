...
In general: \xetex\ supports Unicode filenames, as long as all
characters are on the Basic Multilingual Plane (character codes $\le$
U+FFFF). Unfortunately, characters in higher planes are not
supported in filenames.
% https://tug.org/pipermail/tex-live/2023-November/049686.html
...
respectively; they don't actually define a group.
